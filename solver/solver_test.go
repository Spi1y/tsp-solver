...
func runSolverTest(t *testing.T, qType tasks.QueueType) {
	tests := solveTestCases()
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := &Solver{}
			s.DistanceMatrix = tt.distanceMatrix
			path, dist, err := s.Solve(qType)
...
func TestSolver_SolveWithList(t *testing.T) {
	runSolverTest(t, tasks.QueueLinkedList)
}

func TestSolver_SolveWithHeap(t *testing.T) {
	runSolverTest(t, tasks.QueueHeap)
}
...
func solveTestCaseNil() *solveTestCase {
